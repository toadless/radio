...
public class Guilds extends TableImpl<GuildsRecord> {
    ...
    /**
     * The column <code>public.guilds.dj_role</code>.
     */
    public final TableField<GuildsRecord, Long> DJ_ROLE = createField(DSL.name("dj_role"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("'-1'::integer", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.guilds.prefix</code>.
     */
    public final TableField<GuildsRecord, String> PREFIX = createField(DSL.name("prefix"), SQLDataType.VARCHAR(5).nullable(false).defaultValue(DSL.field("'r!'::character varying", SQLDataType.VARCHAR)), this, "");
